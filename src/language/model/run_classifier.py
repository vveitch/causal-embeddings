...
import model.bert_predictors as predictors
from dataset.dataset import make_input_fn_from_file
...
def main(_):
    ...
    model_fn = predictors.binary_treat_binary_response_model_fn_builder(
    ...
    if FLAGS.do_train:
        ...
        with tf.name_scope("training_data"):
            train_input_fn = make_input_fn_from_file(
                ...
                tokenizer=tokenizer,
                is_training=True,
                shuffle_buffer_size=100,  # note: bert hardcoded this, and I'm following suit
                seed=FLAGS.seed)
